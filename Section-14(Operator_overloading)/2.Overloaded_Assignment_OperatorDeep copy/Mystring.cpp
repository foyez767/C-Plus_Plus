...
So, when we return this, the compiler expect from us to return Mystring *
In this case, we are returning a Mystring object, so we must dereference the this pointer to get the object.
So we return *this   */
